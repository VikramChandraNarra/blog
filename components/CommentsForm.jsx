...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="cardView shadow-lg rounded-lg p-8 pb-12 mb-8">
      <h3 className="text-xl mb-8 font-semibold border-b dark pb-4">Leave a Reply</h3>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="dark cursor-pointer" htmlFor="storeData"> Save my name, email in this browser for the next time I comment.</label>
        </div>
      </div>
      {error && <p className="text-xs pink">All fields are mandatory</p>}
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-indigo-900 inline-block bgpink text-lg font-medium rounded-full light px-8 py-3 cursor-pointer">Post Comment</button>
